...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(35, 85);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(95, 23);
			this->button1->TabIndex = 1;
			this->button1->Text = L"Користувач";
			...
			this->button2->Location = System::Drawing::Point(165, 85);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(94, 23);
			this->button2->TabIndex = 2;
			this->button2->Text = L"Адмін";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &MyForm::button2_Click);
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(97, 137);
			...
			this->button3->Location = System::Drawing::Point(109, 176);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(75, 23);
			this->button3->TabIndex = 4;
			this->button3->Text = L"Увійти";
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Georgia", 8.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->ForeColor = System::Drawing::Color::GreenYellow;
			this->label2->Location = System::Drawing::Point(106, 120);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(74, 14);
			this->label2->TabIndex = 5;
			this->label2->Text = L"Введіть імя";
			// 
			// button4
			// 
			...
			this->button5->Location = System::Drawing::Point(104, 38);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(83, 23);
			this->button5->TabIndex = 7;
			this->button5->Text = L"Результати";
			...
			this->button6->Location = System::Drawing::Point(193, 38);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(83, 23);
			this->button6->TabIndex = 8;
			this->button6->Text = L"Теорія";
...
private: System::Void button3_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	if (textBox1->Text == "")
	{
		...
		label1->Visible = true;
		label1->Text = "Ви увійшли як " + textBox1->Text;
	}
}
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	fscanf(f3, "%d", &i);
	fclose(f3);
	MyForm1 ^ FS1 = gcnew MyForm1(System_to_char(textBox1->Text));
	int m = i / 60;
	MessageBox::Show("Тест має обмеження в часі " + m.ToString() + " хвилин");
	FS1->Show();
}
