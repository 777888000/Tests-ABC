...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Papyrus", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(28, 40);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(216, 33);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Dyshkantiuk Yaroslav";
			...
			this->label2->Text = L"Програма тестування";
			// 
			// MyForm8
			// 
